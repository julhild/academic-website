        ...
        <div className="group-member-info">
            ...
            <div className="contact">
                ...
                <div className="social">
                    ...
                    {groupMember.twitter && 
                        <Link to="" className='social-link'
                            onClick={() => window.open(`${groupMember.twitter}`)}>
                            <FaTwitter />
                        </Link>
                    }
                    ...
                    <Link to="" className='social-link'
                            onClick={() => window.open(`${groupMember.instagram}`)}>
                            <FaInstagram />
                    </Link>
                    }
            ...
            <div className='expand'>
                <div className="group-member-buttons">
                    <button className={showResearch ? 'expand-button expand-active' : 'expand-button'} onClick={showResearchArea}>
                        <FaMicroscope/> Research
                    </button>

                    <button className={showCV ? 'expand-button expand-active' : 'expand-button'} onClick={showCVArea}>
